...
- **Category:** `workspace`
- **Tags:** `workspace, mib-deep-link-apps, pipes`
- **Keywords:** `pipes, Pipes, Automations`
- **Aliases:** `pipes, pipes`
...
- search terms: pipes, Pipes, Automations
- related tags: workspace, mib-deep-link-apps, pipes
