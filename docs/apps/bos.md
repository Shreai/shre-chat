...
- **Category:** `product`
- **Tags:** `product, subdomain-apps, bos`
- **Keywords:** `bos, BOS, Back Office`
- **Aliases:** `bos, bos`
- **Domain:** `Subdomain`
- **Owner:** `<owner or team>`
...
- search terms: bos, BOS, Back Office
- related tags: product, subdomain-apps, bos
