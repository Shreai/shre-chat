...
- **Category:** `workspace`
- **Tags:** `workspace, mib-deep-link-apps, goals`
- **Keywords:** `goals, Goals, OKRs & Goals`
- **Aliases:** `goals, goals`
...
- search terms: goals, Goals, OKRs & Goals
- related tags: workspace, mib-deep-link-apps, goals
