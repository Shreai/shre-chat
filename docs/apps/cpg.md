...
- **Category:** `product`
- **Tags:** `product, subdomain-apps, cpg`
- **Keywords:** `cpg, CPG Intel, Brand Intelligence`
- **Aliases:** `cpg intel, cpg`
- **Domain:** `Subdomain`
- **Owner:** `<owner or team>`
...
- search terms: cpg, CPG Intel, Brand Intelligence
- related tags: product, subdomain-apps, cpg
