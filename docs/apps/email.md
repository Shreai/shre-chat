...
- **Category:** `workspace`
- **Tags:** `workspace, mib-deep-link-apps, email`
- **Keywords:** `email, Email, Inbox & Compose`
- **Aliases:** `email, email`
...
- search terms: email, Email, Inbox & Compose
- related tags: workspace, mib-deep-link-apps, email
