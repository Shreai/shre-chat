                ...
                {group.entries.map((entry) => {
                  ...
                  return (
                    <div key={entry.id} className="relative mb-2">
                      <div
                        className={`absolute -left-[21px] top-1.5 h-3 w-3 rounded-full flex items-center justify-center text-[7px] ${cfg.color}`}
                      ...
                      <div className="flex items-start gap-2 pl-2 py-1">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5">
                            <span
                              className={`text-[9px] font-semibold uppercase tracking-wider ${cfg.color}`}
                            >
                              {cfg.label}
                            </span>
