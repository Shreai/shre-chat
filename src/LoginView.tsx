...
export function LoginView({ onLogin }: LoginProps) {
  ...
  const EyeIcon = ({ open }: { open: boolean }) => (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--c-text-4, #6b6b76)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      {open ? (
        <>
    ...
    <div className="min-h-screen flex items-center justify-center" style={{
      ...
      <div className="w-full max-w-[380px] px-5">
        <div className="text-center mb-8">
          ...
          <h1 className="text-[22px] font-semibold m-0 mb-1" style={{ color: "var(--c-text-1)" }}>Shre Chat</h1>
        ...
        <div className="rounded-2xl p-7" style={{
          ...
          {!needs2FA ? (
            <form ref={formRef} onSubmit={handleSubmit} autoComplete="on">
              ...
              <div className="mb-3">
                ...
                <div className="relative">
                  <SInput
                    ...
                    style={{ background: "var(--c-bg-1)", borderColor: "var(--c-border-2)", borderRadius: 10, paddingRight: 40 }}
                  />
                  <button
                    type="button"
              ...
              <label className="flex items-center gap-2 text-xs mb-5 cursor-pointer select-none" style={{ color: "var(--c-text-3)" }}>
                <input
                  type="checkbox"
                  checked={rememberMe}
            ...
            <form onSubmit={handleVerify2FA}>
              ...
              <SButton
                ...
                style={{ borderRadius: 10, borderColor: "var(--c-border-2)", color: "var(--c-text-3)" }}
