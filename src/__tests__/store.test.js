...
const localStorageMock = {
    ...
    key: vi.fn((i) => Array.from(localStorageMap.keys())[i] ?? null),
};
...
import { uid, createSession, generateTitle, loadSessions, saveSessions, loadActiveSession, saveActiveSession, loadQueue, saveQueue, loadActivity, saveActivity, loadFeed, saveFeed, loadFiles, saveFiles, loadTabs, saveTabs, debouncedSaveSessions, flushPendingSave, loadThemeCustom, saveThemeCustom, getAgent, AGENTS, } from '../store';
// ── Setup / Teardown ─────────────────────────────────────────────────
beforeEach(() => {
