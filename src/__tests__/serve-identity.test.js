...
import { createMockLogger, createMockReq, createMockRes, createJsonHelper, createRateLimitHelper, createAuthCookieHelper, getJsonResponse, } from './route-test-helpers';
...
let handleAuth;
beforeAll(() => {
    handleAuth = registerAuthRoutes({ log: log });
});
/** Helper to POST an identity verification request */
async function verifyIdentity(body, opts = {}) {
