...
import { useApp, uid, generateTitle, getAgent, AGENTS, shareSession, type UploadedFile, type Session } from "./store";
...
export function ChatView() {
  ...
  const { sessions, activeSessionId, activeAgentId, openTabs, streaming, streamText, statusLine, gatewayUp, syncing } = state;
