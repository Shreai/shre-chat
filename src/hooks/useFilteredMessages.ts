...
export function useFilteredMessages({ messages, latestTask, runs, scrollRef }: UseFilteredMessagesOptions) {
  ...
  const getRunForMessage = useCallback((msg: ChatMessage, _msgIndex: number): ProcessRun | null => {
