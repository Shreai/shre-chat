...
interface UseProactiveNotificationsResult {
  pendingNotifs: Notification[];
  speakNext: () => Notification | null;
  clearQueue: () => void;
  isConnected: boolean;
}
...
export function useProactiveNotifications(enabled: boolean): UseProactiveNotificationsResult {
