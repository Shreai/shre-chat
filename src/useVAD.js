...
export function useVAD(options = {}) {
    const { speechThreshold = 0.015, silenceDuration = 4000, onSilence, onSpeechStart, onSpeechEnd, } = options;
    ...
    const startBargeInMonitor = useCallback((stream, onBargeIn) => {
        if (!activeRef.current) {
