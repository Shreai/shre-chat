...
export const SITEMAP = [
    ...
    },
    {
        id: 'tasks',
        label: 'Tasks',
        description: 'View and manage all tasks — filter by status, priority, agent. Quick actions to start, complete, approve tasks.',
        category: 'work',
        type: 'view',
    ...
    },
    {
        id: 'reminders',
        label: 'Reminders',
        description: 'Personal reminders with natural language input, recurring schedules, snooze, and due alerts',
        category: 'work',
        type: 'view',
    ...
    },
    {
        id: 'task-timeline',
        label: 'Task Timeline',
        description: 'Gantt chart visualization of tasks over time — see task durations, dependencies, agent assignments',
        category: 'work',
        type: 'view',
    ...
    },
    {
        ...
        description: 'Real-time investor KPIs — business metrics, platform health, AI agent ROI, market opportunities, roadmap',
        category: 'analytics',
        type: 'view',
        keywords: [
            'investor', 'investors', 'kpi', 'metrics', 'revenue', 'arr', 'mrr',
            'pipeline', 'roi', 'fundraising', 'traction', 'roadmap', 'dashboard',
        ],
    },
];
/**
