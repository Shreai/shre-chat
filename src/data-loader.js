 ...
 */
async function getCredentials(tenant = 'party-liquor') {
    try {
 ...
 */
async function authenticateRapidRMS(credentials) {
    try {
 ...
 */
function generateMockMetrics(date, seed = 0) {
 ...
 */
export function formatDataForChat(data) {
 ...
 */
export function compareDataPeriods(period1, period2) {
